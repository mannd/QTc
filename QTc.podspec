#
#  Be sure to run `pod spec lint QTc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
The goal is to provide an exhaustive set of documented and tested corrected QT (QTc) formulas for using in medical apps.
                   DESC

  s.homepage     = "https://epstudiossoftware.com"
