...
struct Formulas: QTcFormulaSource, QTpFormulaSource {
    ...
    static let qtcDictionary: [QTcFormula : QTcCalculator] = [.qtcBzt: QTcCalculator(formula: .qtcBzt, longName: "Bazett", shortName: "QTcBZT",
                                                                                     ...
                                                                                     equation: "QT/RR^0.5",
                                                                                     baseEquation: {qtInSec, rrInSec in qtcExp(qtInSec: qtInSec, rrInSec: rrInSec, exp: 0.5)}, classification: .power, notes: "Oldest, most common formula, but inaccurate at extremes of heart rate"),
                                                              .qtcFrd:
                                                                QTcCalculator(formula: .qtcFrd, longName: "Fridericia", shortName: "QTcFRM",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtcExp(qtInSec: qtInSec, rrInSec: rrInSec, exp: 1 / 3.0)}, classification: .power),
                                                              .qtcMyd:
                                                                QTcCalculator(formula: .qtcMyd, longName: "Mayeda", shortName: "QTcMYD",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtcExp(qtInSec: qtInSec, rrInSec: rrInSec, exp: 0.604)}, classification: .power),
                                                              .qtcFrm:
                                                                QTcCalculator(formula: .qtcFrm, longName: "Framingham (Sagie)", shortName: "QTcFRM",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtcLinear(qtInSec: qtInSec, rrInSec: rrInSec, alpha: 0.154)}, classification: .linear),
                                                              .qtcHdg:
                                                                QTcCalculator(formula: .qtcHdg, longName: "Hodges", shortName: "QTcHDG",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtInSec + 0.00175 * (QTc.secToBpm(rrInSec) - 60)}, classification: .rational),
                                                              .qtcRtha:
                                                                QTcCalculator(formula: .qtcRtha, longName: "Rautaharju (2014)a", shortName: "QTcRTHa",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtInSec * (120.0 + QTc.secToBpm(rrInSec)) / 180.0}, classification: .rational),
                                                              .qtcArr:
                                                                QTcCalculator(formula: .qtcArr, longName: "Arrowood", shortName: "QTcARR",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtInSec + 0.304 - 0.492 * exp(-0.008 * QTc.secToBpm(rrInSec))}, classification: .other),
                                                              .qtcKwt:
                                                                QTcCalculator(formula: .qtcKwt, longName: "Kawataki", shortName: "QTcKWT",
                                                                              ...
                                                                              equation: "QT/RR^0.25",
                                                                              baseEquation: {qtInSec, rrInSec in qtcExp(qtInSec: qtInSec, rrInSec: rrInSec, exp: 0.25)}, classification: .power),
                                                              .qtcDmt:
                                                                QTcCalculator(formula: .qtcDmt, longName: "Dimitrienko", shortName: "QTcDMT",
                                                                              ...
                                                                              baseEquation: {qtInSec, rrInSec in qtcExp(qtInSec: qtInSec, rrInSec: rrInSec, exp: 0.413)}, classification: .power),
                                                                 ]
    ...
    static let qtpDictionary: [QTpFormula : QTpCalculator] = [.qtpArr: QTpCalculator(formula: .qtpArr, longName: "Arrowood", shortName: "QTpARR",
                                                                                     ...
                                                                                     baseEquation: {rrInSec in 0.12 + 0.492 * exp(-0.008 * QTc.secToBpm(rrInSec))}, classification: .exponential)]
